...
from .screenShot_sample_dialog import ScreenShotSampleDialog
import os.path
...
class ScreenShotSample:
    ...
    def run(self):
        if self.first_start == True:
            ...
            self.dlg = ScreenShotSampleDialog(self.iface, self.action, self.iface.mainWindow()) # self.iface.mainWindow()を渡すと、ダイアログがQGISの後ろに隠れないようになります
