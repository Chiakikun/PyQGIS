...
class ScreenShotSample:
    ...
    def initGui(self):
        ...
        self.action = QAction(icon, 'ベクタレイヤのフューチャー毎', self.iface.mainWindow())
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.dlg = ScreenShotSampleDialog(self.iface, self.iface.mainWindow()) # self.iface.mainWindow()を渡すと、ダイアログがQGISの後ろに隠れないようになります
